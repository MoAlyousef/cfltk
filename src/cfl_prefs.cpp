...
Fl_Preferences *Fl_Preferences_new(int root, const char *vendor,
...
Fl_Preferences *Fl_Preferences_from_parent_group(Fl_Preferences *parent,
                                                 const char *group) {
    return new Fl_Preferences(parent, group);
}

Fl_Preferences *Fl_Preferences_from_parent_idx(Fl_Preferences *parent,
                                               int groupIndex) {
...
int Fl_Preferences_filename(Fl_Preferences *prefs, char *buffer,
                            unsigned long buffer_size) {
    return prefs->filename(buffer, buffer_size);
}

char Fl_Preferences_get_userdata_path(Fl_Preferences *prefs, char *path,
                                      int pathlen) {
...
char Fl_Preferences_setf(Fl_Preferences *prefs, const char *entry,
                         float value) {
    return prefs->set(entry, value);
}

char Fl_Preferences_setfp(Fl_Preferences *prefs, const char *entry, float value,
                          int precision) {
    return prefs->set(entry, value, precision);
}

char Fl_Preferences_setd(Fl_Preferences *prefs, const char *entry,
                         double value) {
    return prefs->set(entry, value);
}

char Fl_Preferences_setdp(Fl_Preferences *prefs, const char *entry,
                          double value, int precision) {
    return prefs->set(entry, value, precision);
}

char Fl_Preferences_sets(Fl_Preferences *prefs, const char *entry,
                         const char *value) {
    return prefs->set(entry, value);
}

char Fl_Preferences_setv(Fl_Preferences *prefs, const char *entry,
                         const void *value, int size) {
    return prefs->set(entry, value, size);
}

char Fl_Preferences_geti(Fl_Preferences *prefs, const char *entry, int *value,
                         int defaultValue) {
...
char Fl_Preferences_getd(Fl_Preferences *prefs, const char *entry,
...
char Fl_Preferences_getv(Fl_Preferences *prefs, const char *entry, void *value,
                         const void *defaultValue, int defaultSize,
                         int maxSize) {
