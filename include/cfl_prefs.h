...
Fl_Preferences *Fl_Preferences_new(int root, const char *vendor, const char *application);
...
Fl_Preferences *Fl_Preferences_from_parent_idx(Fl_Preferences *parent, int groupIndex);
...
char Fl_Preferences_setfp(Fl_Preferences *prefs, const char *entry, float value, int precision);

char Fl_Preferences_setd(Fl_Preferences *prefs, const char *entry, double value);

char Fl_Preferences_setdp(Fl_Preferences *prefs, const char *entry, double value, int precision);

char Fl_Preferences_sets(Fl_Preferences *prefs, const char *entry, const char *value);

char Fl_Preferences_setv(Fl_Preferences *prefs, const char *entry, const void *value, int size);

char Fl_Preferences_geti(Fl_Preferences *prefs, const char *entry, int *value, int defaultValue);
